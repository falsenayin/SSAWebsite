                                ...
                                <div className="mt-auto">
                                    {event.registrationLink ? (
                                        <a
                                            ...
                                            className="w-full py-3 px-6 rounded-2xl bg-ssa-black text-ssa-beige font-semibold text-sm hover:bg-ssa-darkgreen transition-all duration-300 flex items-center justify-between group/btn shadow-md"
                                        >
                                            View details
