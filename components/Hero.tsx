    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-fade-in-up delay-300">
          <a href="#contact" className="bg-ssa-gold hover:bg-white text-ssa-black hover:text-ssa-darkgreen font-semibold py-4 px-8 rounded-lg flex items-center justify-center gap-2 transition-all duration-300 shadow-lg hover:shadow-ssa-gold/30 transform hover:-translate-y-1">
            Join Our Community
            <ArrowRight size={20} />
          </a>
          <a href="#events" className="bg-ssa-sage/10 hover:bg-ssa-sage/30 backdrop-blur-md border border-ssa-sage/40 text-ssa-beige font-semibold py-4 px-8 rounded-lg transition-all duration-300 hover:border-ssa-gold/50 flex items-center justify-center">
            Explore Events
          </a>
        </div>
      </div>
