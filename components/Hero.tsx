  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/hero-bg.jpg"
          alt="SSA Members Group Photo"
          className="w-full h-full object-cover opacity-60 mix-blend-overlay blur-[1px] scale-105"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-ssa-darkgreen/80 via-ssa-darkgreen/70 to-ssa-black"></div>
      </div>
