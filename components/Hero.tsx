    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-fade-in-up delay-300">
          ...
          <a
            href="#events"
            className="group bg-transparent border border-ssa-beige/30 hover:border-ssa-gold text-ssa-beige hover:text-ssa-gold font-semibold py-4 px-10 rounded-xl transition-all duration-300 flex items-center gap-3 backdrop-blur-sm"
          >
            Explore Events
